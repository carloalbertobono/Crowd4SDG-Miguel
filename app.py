...
moreparams['places365_aggregated'] = ['outdoor', 'indoor', 'public', 'private']
...
moreparams['coco_animals'] = ['person','bird','cat','dog','horse','sheep','cow','elephant','bear','zebra','giraffe']
moreparams['coco_transport'] = ['bicycle','car','motorcycle','airplane','bus','train','truck','boat','skateboard']
moreparams['coco_landmarks'] = ['traffic light','fire hydrant','stop sign','parking meter','bench']
...
moreparams['b58encode'] = b58encode
